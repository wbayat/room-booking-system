...
public class ClientController extends UserController implements Initializable {
    ...
    public void showBookARoomView(ActionEvent actionEvent) throws IOException {
        if (roomsLayout == null){
            roomsLayout = new FXMLLoader(MainGUI.class.getResource("/fxml/user/client/RoomsContainer.fxml")).load();
        }
    ...
    public void showMyBookingsView(ActionEvent actionEvent) throws IOException {
        if (clientBookings == null){
            clientBookings = new FXMLLoader(MainGUI.class.getResource("/fxml/user/client/BookingsContainer.fxml")).load();
        }
